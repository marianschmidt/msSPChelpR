...
sir_byfutime_tt <- function(df,
  ...
  strata_var_names <- c(rlang::as_string(agegroup_var), rlang::as_string(sex_var), rlang::as_string(region_var), rlang::as_string(icdcat_var), rlang::as_string(year_var))
